      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            ...
            <a href="<?php echo base_url('pimpinan'); ?>">SiParkir.com</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo base_url('pimpinan'); ?>">SP</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
            <li class="dropdown">
              <a href="<?php echo base_url('pimpinan'); ?>"><i class="fas fa-fire"></i><span>Dashboard</span></a>
            </li>
            ...
            <li class="dropdown <?php echo $this->uri->segment(2) == 'forms_advanced_form' || $this->uri->segment(2) == 'forms_editor' || $this->uri->segment(2) == 'forms_validation' ? 'active' : ''; ?>">
              <a href="<?php echo base_url('pimpinan/laporan'); ?>"><i class="far fa-file-alt"></i> <span>Forms Laporan</span></a>
            </li>
