        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
           <div class="login-brand">
              <img src="<?php echo base_url(); ?>assets/img/logo/logo.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
              ...
              <div class="card-body">
                <form method="post" action="<?= base_url('auth/register'); ?>">
                    <div class="form-group">
                      <input id="name" type="text" class="form-control" name="name" placeholder="Full Name" value="<?= set_value('name'); ?>" autofocus>
            ...
            <div class="mt-5 text-muted text-center">
              Do You have an account? <a href="<?php echo base_url(); ?>">Login</a>
            </div>
            <div class="simple-footer">
              Copyright &copy; Si Parkir 2019
            </div>
          </div>
        </div>
      </div>
